...
const dockApps = [
  ...
  { id: 'weather', name: 'Weather', icon: '\u26C5', iconClass: 'dock-icon-weather' },
  { id: 'clock', name: 'Clock', icon: '\uD83D\uDD50', iconClass: 'dock-icon-clock' },
  { id: 'reminders', name: 'Reminders', icon: '\u2705', iconClass: 'dock-icon-reminders' },
